...
const OBJECT_ORDERS = array(
  array("time", "по дате добавления"),
  array("price", "по цене")
);
const OBJECT_SOURCE = array(
...
const OBJECT_EXCLUSIVE = array("id" => 1, "caption" => "Эксклюзив");
const OBJECT_QUICKLY = array("id" => 1, "caption" => "Срочно");
const OBJECT_COUNT_ROOMS = array(
...
const OBJECT_ADDITIONALLY = array(
...
const OBJECT_PRICE_ADDITIONALLY = array(
...
const ROOM_TYPE_OF_ROOM = array(
  array("id" => 1, "caption" => "В квартире / подселение"),
  array("id" => 2, "caption" => "Общежитие")
);