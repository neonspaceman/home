...
class home extends __page
{
  public function add()
  {
    $this->set_title("Добавление дома на аренду");
    ...
    $this->insert_script("/template/js/home_add.js", time());
    $this->set_template("home_add");
  }
  ...
  public function view_list()
  {
    ...
    $this->set_template("home_view_list");
  }
}