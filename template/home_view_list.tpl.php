...
<head>
  ...
  <script>
    var params = {
      orders: <?= json_encode(OBJECT_ORDERS) ?>,
...
<div class="wrapper">
  ...
  <div class="page_title">
    ...
    <div class="main_col objects">
      ...
      // stmt count phones
      $q = "select count(*) `count` from `phones` where `id_landlord` in 
              (select `id_landlord` from `landlords_objects` where `id_object` = ? and `type_object` = ?)";
      ...
      $stmt = __object::get_stmt($order_by, $offset);
      $stmt->execute() or die($db->error);
      ...
      while($object = $res_object->fetch_assoc()):
        ...
        $count_phones = 0;
        $stmt_count_phones->bind_param("is", $object["id"], $object_type);
        ...
        $stmt_landlord->bind_param("is", $object["id"], $object_type);
          ...
          <tr>
            <td>
              ...
              <div class="furniture">
                ...
                <ul class="icons">
                  <?php
                  foreach(OBJECT_FURNITURE as $furniture)
            ...
            <td>
              ...
              <div class="multimedia">
                ...
                <ul class="icons">
                  <?php
                  foreach(OBJECT_MULTIMEDIA as $multimedia)
          ...
          <tr>
            <td colspan="2">
              ...
              <div class="comfort">
                ...
                <ul class="icons">
                  <?php
                  foreach(OBJECT_COMFORT as $comfort)
