...
$object_type = "home";
$q = "select
        `homes`.`id`, `source`, `exclusive`, `quickly`, `id_region`, `id_street`, `house`, `guide`, `lon`, `lat`,
        `count_rooms`, `related_rooms`, `count_sleeps`, `floors`, `square_general`, `square_living`, `square_kitchen`,
      ...
      from 
        ...
        left join `regions` on `regions`.`id` = `homes`.`id_region`
      where 
        `homes`.`id` = ?
      limit 1";
...
$object["floors"] = $object["floors"] ? $object["floors"] . "&nbsp;" . get_num_ending($object["floors"], array("этаж", "этажа", "этажей")) : false;
  ...
  <div class="page_title">
    ...
    <div class="dynamic_columns">
      <div class="dynamic_column"><?php if ($object["source"] || $object["exclusive"] || $object["quickly"]): ?>
        ...
        if ($object["floors"] || $object["count_rooms"] || $object["count_sleeps"] ||
        ...
        <ul class="group_options column">
          ...
          <li class="option">
            <span class="option_label">Этажность:</span>
            <span class="option_value"><?= $object["floors"] ?></span>
          </li>
          <?php endif; ?>
