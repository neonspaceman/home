...
$object["source"] = __ui::get_value(FLAT_SOURCE, $object["source"]);
...
$object["wc"] = __ui::get_value(FLAT_WC, $object["wc"]);
$object["heating"] = __ui::get_value(FLAT_HEATING, $object["heating"]);
$object["hot_water"] = __ui::get_value(FLAT_HOT_WATER, $object["hot_water"]);
$object["window"] = __ui::get_value(FLAT_WINDOW, $object["window"]);
$object["state"] = __ui::get_value(FLAT_STATE, $object["state"]);
$object["type_balcony"] = __ui::get_value(FLAT_TYPE_BALCONY, $object["type_balcony"]);
$object["balcony"] = $object["count_balcony"]
  ? $object["count_balcony"] . ($object["type_balcony"] ? ", " . $object["type_balcony"] : "")
  : false;
$object["furniture"] = __ui::get_values_by_mask(FLAT_FURNITURE, $object["furniture"]);
$object["multimedia"] = __ui::get_values_by_mask(FLAT_MULTIMEDIA, $object["multimedia"]);
$object["comfort"] = __ui::get_values_by_mask(FLAT_COMFORT, $object["comfort"]);
$object["additionally"] = __ui::get_values_by_mask(FLAT_ADDITIONALLY, $object["additionally"]);
$object["for_whom"] = __ui::get_values_by_mask(FLAT_FOR_WHOM, $object["for_whom"]);
...
$object["prepayment"] = $object["prepayment"]
  ...
  : false;
$object["price_additionally"] = __ui::get_values_by_mask(FLAT_PRICE_ADDITIONALLY, $object["price_additionally"]);
    ...
    <div class="dynamic_columns">
      ...
      <div class="dynamic_column">
        ...
        <?php while($image = $res->fetch_assoc()): ?>
          <div class="cover"><img onclick="PhotoViewer.show(<?= $image["id"] ?>);" src="<?= $image["thumb"] ?>" /></div>
        <?php endwhile; ?>
        </div>
        <?php
        endif;
